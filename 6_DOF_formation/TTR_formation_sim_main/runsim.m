...
% trajhandle = @traj_vtol_cruise; % --todo

trajhandle = @traj_formation_circle_lift;
% trajhandle = @traj_vtol_cruise_circle; % -- todo
% trajhandle = @traj_cruise;  % -- todo
...
[t, state] = simulation_formation_ttr(trajhandle, controlhandle, num_agents); 
