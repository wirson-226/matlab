classdef AircraftControl_ori
    ...
    methods
        % Constructor
        function obj = AircraftControl_ori(params)
            ...
            obj.vu_from_pu = PIDControl(params.pd_kp, params.pd_ki, params.pd_kd, params.Ts, params.sigma, params.vz_sat_limit);
            ...
            obj.pitch_from_altitude = PIControl(params.altitude_kp, params.altitude_ki, params.Ts, np2rad(30));
