function [F, M] = controller_adrc_NL(t, state, des_state, params)
...
z_pos(:,1) = ESO_NL(z_pos(:,1), state.pos(1), u1, params, 'alt');
z_pos(:,2) = ESO_NL(z_pos(:,2), state.pos(2), u1, params, 'alt');
z_pos(:,3) = ESO_NL(z_pos(:,3), state.pos(3), u1, params, 'alt');
