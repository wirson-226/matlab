function [des_from_ctrl,command,copter_cmd] = copter_controller_Done(t, state, des_state, params)
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if t > 2
        roll_cmd =  deg2rad(20);
        yaw_cmd = deg2rad(0-5*t);
        pitch_cmd = deg2rad(20);
    end
    ...
    % 测试侧滑角
    r_cmd =  controller.yaw_rate_from_yaw.update(yaw_cmd, state.rot(3));
