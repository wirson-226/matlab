function [F, M, ATT_des] = controller_pid_NL(t, state, des_state, params)
...
Kd_pos = [5; 5; 9];  % Position derivative gain
...
phi_des = asin((acc_des(1) * sin(des_state.yaw) - acc_des(2) * cos(des_state.yaw)) / acc_total);
