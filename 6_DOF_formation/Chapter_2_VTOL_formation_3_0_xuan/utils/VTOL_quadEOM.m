function[sdot, att_des ] = VTOL_quadEOM(t, s, controlhandle, trajhandle, params, global_state, global_des_state, agent)
...
% Get desired_state
desired_state = trajhandle(t, agent);

% get control outputs
[F, M, att_des] = controlhandle(t, current_state, desired_state, params, global_state, global_des_state, agent);  % s: [13 * 1]; 

% compute derivative
sdot = VTOL_quadEOM_readonly(t, s, F, M, params);  % sdot : [13 * 1]; att_des_save: [3 * 1];
