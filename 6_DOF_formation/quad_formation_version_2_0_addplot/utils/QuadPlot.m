classdef QuadPlot < handle
    ...
    methods
        ...
        function Q = QuadPlot(qn, state, wingspan, height, color, max_iter, h_3d)
            ...
            Q.h_pos_hist = plot3(Q.h_3d, Q.state(1), Q.state(2), Q.state(3), 'color' , Q.color, 'LineStyle', '-','LineWidth', 1.5); % 将绘图线条改为红色实线
            Q.h_pos_des_hist = plot3(Q.h_3d, Q.des_state(1), Q.des_state(2), Q.des_state(3), 'b.', 'LineStyle', '-','LineWidth', 1.5); % 将绘图线条改为蓝色实线
