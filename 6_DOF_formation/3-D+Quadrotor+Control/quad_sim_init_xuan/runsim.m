...
trajhandle = @traj_helix; % 分析不同，设定单机轨迹，并拓展多机编队；
...
% [t, state] = simulation_3d(trajhandle, controlhandle); % 实测试版
[t, state] = simulation_3d_att_plus_1_1_over(trajhandle, controlhandle); % 姿态跟踪完成版1_1，扩展接口实现
% [t, state] = simulation_3d_att_plus(trajhandle, controlhandle); % 添加姿态跟踪效果
